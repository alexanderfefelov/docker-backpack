...
CREATE TABLE `domain` (
  ...
  `comment` TEXT NOT NULL,
  PRIMARY KEY (`id`));CREATE TABLE `contract_password_once` (
...
CREATE USER 'bill'@'127.0.0.1' IDENTIFIED BY 'bgbilling';
GRANT ALL PRIVILEGES ON `bgbilling`.* TO 'bill'@'127.0.0.1' WITH GRANT OPTION;
